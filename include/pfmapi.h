...
/*interface PfmMount*/ typedef struct PfmMount_vtbl_t PfmMount_vtbl_t, * PfmMount; struct PfmMount_vtbl_t
{
   ...
   wchar_t const* (PT_CCALL* GetMountSourceName)( PfmMount*);
   wchar_t const* (PT_CCALL* GetMountPoint)( PfmMount*);
   wchar_t const* (PT_CCALL* GetUncName)( PfmMount*);
   wchar_t const* (PT_CCALL* GetOwnerId)( PfmMount*);
   wchar_t const* (PT_CCALL* GetOwnerName)( PfmMount*);
   wchar_t const* (PT_CCALL* GetFormatterName)( PfmMount*);
   ...
   int /*err*/ (PT_CCALL* Control)( PfmMount*, int controlCode, void const* input, size_t inputSize, void* output, size_t maxOutputSize, size_t* outputSize);
   wchar_t const* (PT_CCALL* GetMountEndName)( PfmMount*);
   wchar_t const* (PT_CCALL* GetAppId)( PfmMount*);
};
...
/*interface PfmFileMountUi*/ typedef struct PfmFileMountUi_vtbl_t PfmFileMountUi_vtbl_t, * PfmFileMountUi; struct PfmFileMountUi_vtbl_t
{
   ...
   void (PT_CCALL* Complete)( PfmFileMountUi*, wchar_t const* errorMessage);
   void (PT_CCALL* Status)( PfmFileMountUi*, wchar_t const* data, int/*bool*/ endOfLine);
   void (PT_CCALL* Suspend)( PfmFileMountUi*);
   void (PT_CCALL* Resume)( PfmFileMountUi*);
   wchar_t const* (PT_CCALL* QueryPassword)( PfmFileMountUi*, wchar_t const* prompt, int count);
...
/*interface PfmFileMount*/ typedef struct PfmFileMount_vtbl_t PfmFileMount_vtbl_t, * PfmFileMount; struct PfmFileMount_vtbl_t
{
   ...
   int /*err*/ (PT_CCALL* GetInterface)( PfmFileMount*, char const* id, void*);
   void (PT_CCALL* Cancel)( PfmFileMount*);
   int /*err*/ (PT_CCALL* Start)( PfmFileMount*, PfmFileMountCreateParams const* params_);
   void (PT_CCALL* Send)( PfmFileMount*, wchar_t const* data, int/*bool*/ endOfLine);
   void (PT_CCALL* Status)( PfmFileMount*, wchar_t const* data, int/*bool*/ endOfLine);
...
/*interface PfmApi*/ typedef struct PfmApi_vtbl_t PfmApi_vtbl_t, * PfmApi; struct PfmApi_vtbl_t
{
   ...
   char const* (PT_CCALL* Version)( PfmApi*);
   int /*err*/ (PT_CCALL* SysStart)( PfmApi*);
   int /*err*/ (PT_CCALL* MountCreate)( PfmApi*, PfmMountCreateParams const* params_, PfmMount** mount);
   int /*err*/ (PT_CCALL* MountSourceNameOpen)( PfmApi*, wchar_t const* mountSourceName, PfmMount** mount);
   int /*err*/ (PT_CCALL* MountPointOpen)( PfmApi*, wchar_t const* mountPoint, PfmMount** mount);
   ...
   void (PT_CCALL* FastPipeSend)( PfmApi*, PT_FD_T clientFd, int clientContext, uint64_t offset, void const* input, size_t maxInputSize, void* output, size_t maxOutputSize, PfmFastPipeSendContext*);
   int /*err*/ (PT_CCALL* MountEndNameOpen)( PfmApi*, wchar_t const* mountEndName, PfmMount** mount);
};
...
/*interface PfmMarshallerOpenOp*/ typedef struct PfmMarshallerOpenOp_vtbl_t PfmMarshallerOpenOp_vtbl_t, * PfmMarshallerOpenOp; struct PfmMarshallerOpenOp_vtbl_t
{
   ...
   void (PT_CCALL* Complete)( PfmMarshallerOpenOp*, int perr, uint8_t/*bool*/ existed, PfmOpenAttribs const* openAttribs, int64_t parentFileId, wchar_t const* endName, size_t linkNamePartCount, void const* linkData, size_t linkDataSize, PfmFormatterSerializeOpen* serializeOpen);
};
...
/*interface PfmMarshallerMoveOp*/ typedef struct PfmMarshallerMoveOp_vtbl_t PfmMarshallerMoveOp_vtbl_t, * PfmMarshallerMoveOp; struct PfmMarshallerMoveOp_vtbl_t
{
   ...
   void (PT_CCALL* Complete)( PfmMarshallerMoveOp*, int perr, uint8_t/*bool*/ existed, PfmOpenAttribs const* openAttribs, int64_t parentFileId, wchar_t const* endName, size_t linkNamePartCount, void const* linkData, size_t linkDataSize, PfmFormatterSerializeOpen* serializeOpen);
};
...
/*interface PfmMarshallerFlushFileOp*/ typedef struct PfmMarshallerFlushFileOp_vtbl_t PfmMarshallerFlushFileOp_vtbl_t, * PfmMarshallerFlushFileOp; struct PfmMarshallerFlushFileOp_vtbl_t
{
   ...
   void const* (PT_CCALL* LinkData)( PfmMarshallerFlushFileOp*);
...
/*interface PfmMarshallerListOp*/ typedef struct PfmMarshallerListOp_vtbl_t PfmMarshallerListOp_vtbl_t, * PfmMarshallerListOp; struct PfmMarshallerListOp_vtbl_t
{
   ...
   uint8_t/*bool*/ (PT_CCALL* Add)( PfmMarshallerListOp*, PfmAttribs const* attribs, wchar_t const* endName);
   uint8_t/*bool*/ (PT_CCALL* Add8)( PfmMarshallerListOp*, PfmAttribs const* attribs, char const* endName);
...
/*interface PfmMarshallerWriteOp*/ typedef struct PfmMarshallerWriteOp_vtbl_t PfmMarshallerWriteOp_vtbl_t, * PfmMarshallerWriteOp; struct PfmMarshallerWriteOp_vtbl_t
{
   ...
   void const* (PT_CCALL* Data)( PfmMarshallerWriteOp*);
...
/*interface PfmMarshallerControlOp*/ typedef struct PfmMarshallerControlOp_vtbl_t PfmMarshallerControlOp_vtbl_t, * PfmMarshallerControlOp; struct PfmMarshallerControlOp_vtbl_t
{
   ...
   void const* (PT_CCALL* Input)( PfmMarshallerControlOp*);
...
/*interface PfmMarshallerMediaInfoOp*/ typedef struct PfmMarshallerMediaInfoOp_vtbl_t PfmMarshallerMediaInfoOp_vtbl_t, * PfmMarshallerMediaInfoOp; struct PfmMarshallerMediaInfoOp_vtbl_t
{
   ...
   void (PT_CCALL* Complete)( PfmMarshallerMediaInfoOp*, int perr, PfmMediaInfo const* mediaInfo, wchar_t const* mediaLabel);
};
...
/*interface PfmMarshallerWriteXattrOp*/ typedef struct PfmMarshallerWriteXattrOp_vtbl_t PfmMarshallerWriteXattrOp_vtbl_t, * PfmMarshallerWriteXattrOp; struct PfmMarshallerWriteXattrOp_vtbl_t
{
   ...
   void const* (PT_CCALL* Data)( PfmMarshallerWriteXattrOp*);
...
/*interface PfmMarshaller*/ typedef struct PfmMarshaller_vtbl_t PfmMarshaller_vtbl_t, * PfmMarshaller; struct PfmMarshaller_vtbl_t
{
   ...
   void (PT_CCALL* SetTrace)( PfmMarshaller*, wchar_t const* traceChannelName);
   void (PT_CCALL* SetStatus)( PfmMarshaller*, PT_FD_T fd);
   void (PT_CCALL* Line)( PfmMarshaller*, wchar_t const* data, uint8_t/*bool*/ endOfLine);
   void (PT_CCALL* Print)( PfmMarshaller*, wchar_t const* data);
   void (PT_CCALL* Vprintf)( PfmMarshaller*, wchar_t const* format, va_list args);
   void (PT_CCALL* Printf)( PfmMarshaller*, wchar_t const* format, ...);
   int /*perr*/ (PT_CCALL* ConvertSystemError)( PfmMarshaller*, int err);
   int /*err*/ (PT_CCALL* Identify)( PfmMarshaller*, void const* mountFileData, size_t mountFileDataSize, char const* formatterName);
   int /*err*/ (PT_CCALL* GetPassword)( PfmMarshaller*, PT_FD_T read, wchar_t const* prompt, wchar_t const** password);
